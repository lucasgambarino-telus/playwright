...
- Name: MOB - Overpaid balance
- Location: /Users/lucas.gambarino/Documents/GitHub/playwright/tests/mob-intents.spec.js:92:3
...
Call log:
  ...
  - waiting for getByRole('button', { name: /Continue to TELUS Expert/i })
    ...
    at /Users/lucas.gambarino/Documents/GitHub/playwright/tests/mob-intents.spec.js:61:38
    at /Users/lucas.gambarino/Documents/GitHub/playwright/tests/mob-intents.spec.js:93:5
```
...
- complementary "Chat":
  ...
  - paragraph: Friday June 6, 3:53 p.m.
  ...
  - paragraph: 15:54
  - text: Overpaid balance
  - paragraph: You 15:54
  - paragraph: I'm not sure I understand.
  - paragraph: Can you reword that for me?
  - paragraph: 15:54
  - text: agent
  - paragraph: You 15:54
  - paragraph: Sure, let me see if a team member is available at this time.
  - paragraph: To ensure I get you to the correct team member, please select from one of the options below.
...
```ts
   ...
   6 | const { mobScenarios } = require('../fixtures/test-scenarios');
   7 |
...
> 61 |         await expect(continueButton).toBeVisible();
  ...
  91 | mobScenarios.testCases.forEach(testCase => {
  92 |   test(`MOB - ${testCase.intent}`, async ({ runIntentTest }) => {

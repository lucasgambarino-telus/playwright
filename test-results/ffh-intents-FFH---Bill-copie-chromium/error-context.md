...
- complementary "Chat":
  ...
  - paragraph: Friday June 6, 3:48 p.m.
  ...
  - text: Bill copie
  - paragraph: You 15:48
  - paragraph: With paperless billing, you can view, download and/or print bills from up to 18 months ago.
  - paragraph: "How to reprint an invoice:"
  - paragraph:
    - text: "1."
    - link "Log in to your My TELUS account here":
      - /url: https://www.telus.com/my-account/billing/bill_summary?INTCMP=Tcom_VirtualAssistant&linktype=virtual_assistant
    - text: If you have multiple accounts, select the account you want to view 2. Scroll down to Past bills and select the bill you would like to view and print 📌 If the bills you need are not in the last 18 posted through your online account, an agent can reprint them for you
  - paragraph:
    - link "Learn more about bill reprinting options and fees":
      - /url: https://www.telus.com/en/bc/support/article/service-fees?INTCMP=Tcom_VirtualAssistant
  - paragraph: Can I assist you with anything else?
  - paragraph: 15:48
  - text: agent
  - paragraph: You 15:48
